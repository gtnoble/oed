...
## Supported systems
hed should run on any minimally `POSIX` operating system.
Pull requests are much appreciated to support more operating systems.
## Supported compilers
hed is known to build with the following C compilers:
...
## Dependencies
Any C89 compiler should be able to compile hed. Please see the
